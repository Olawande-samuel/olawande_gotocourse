                                            ...
                                            .map(
                                                (
                                                    ...
                                                    <UserInfoCard
                                                        ...
                                                        num={i}
                                                        date={
                                                            "2022-06-26T00:00:00.000Z".split(
                                                                "T"
                                                            )[0]
                                                        }
                                                        students={90}
...
export function CreateCourseCategory() {
            ...
            (async () => {
                try {
                    ...
                    if (!success) throw new AdvancedError(message, statusCode);
                        ...
                        data.nicheItems &&
                            setNichelists((_) => data.nicheItems);
                        data.careerList &&
                            setCareerlists((_) => data.careerList);
                        toast.success(message);
                    } else {
    ...
    function updateCareerHandler(e) {
        if (
            careerlist.name.trim() !== "" ||
            careerlist.description.trim() !== ""
        ) {
            setCareerlists((old) => {
            ...
            <div className={clsx["admin_profile"]}>
              ...
              <Info title={title} content={content} key={i} />
                        ...
                        <div className={clsx.user__email}>
                            <button
                                onClick={(e) =>
                                    deleteUserHandler(e, data?.email)
                                }
                            >
                        ...
                        <button
                            ...
                            style={{
                                backgroundColor:
                                    data?.isVerified && "var(--theme-orange",
                            }}
                            type="submit"
            ...
            try {
                ...
                if (!pledreId)
                    throw new AdvancedError(
                        "User is not registered to your school.",
                        0
                    );
              ...
              <Info title={title} content={content} key={i} />
                        ...
                        <div className="form-group my-3">
                            ...
                            <Switch
                                ...
                                checked={
                                    data?.userType === "mentor" ? true : false
                                }
                                value="mentorship"
                            />
                        </div>
        ...
        >
                    ...
                    {img && (
                        <img
                            src={
                                isAbsolute
                                    ? img
                                    : `${process.env.REACT_APP_IMAGEURL}/${img}`
                            }
                            alt="avatar"
                        />
                    )}
            ...
            {accessPledre !== null && (
                <td className={clsx.user__button}>
                    <span>
                        <Switch
                            onClick={handlePledreAccess}
                            checked={accessPledre}
                        />
                    </span>
                </td>
            )}
                                    ...
                                    teachers
                                        ...
                                        .map((teacher, i) => (
                                            <UserInfoCard
                                                ...
                                                user={true}
                                                firstName={
                                                    teacher.mentorFirstName
                                                }
                                                lastName={
                                                    teacher.mentorLastName
                                                }
        ...
        <Admin header="Mentor Details">
            <div className={clsx["admin_profile"]}>
                ...
                <div className={clsx["admin_profile_main"]}>
                    ...
                    <div className={clsx.admin__profile_info}>
                        <div className={clsx.admin__info}>
                            <span className={clsx.admin__info_title}>
                                Email
                            </span>
...
export function CourseDetails({}) {
    ...
    async function toggleCourseStatusHandler(e) {
        ...
        try {
            if (formstate.status !== "active") {
                ...
                const res = await toggleCourseStatus(
                    userdata?.token,
                    params?.id
                );
                const { success, message, statusCode } = res;
    ...
    async function deleteTutor() {
        ...
        let startDate = new Date(formstate.startDate)
            .toISOString()
            .split("T")[0];
                    ...
                    >
                        ...
                        >
                            ...
                            <Switch
                                ...
                                checked={
                                    formstate.status === "active" ? true : false
                                }
                            />
                        </div>
                    </form>
        ...
        (async () => {
            try {
                ...
                if (!success) throw new AdvancedError(message, statusCode);
                    ...
                    const { data } = res;
                    let bootcamp = data.find(
                        (d) => d.bootcampId === params?.id
                    );
        ...
        <Admin header={location.search ? "Edit Class" : "Create Class"}>
            ...
            <div className={clsx.admin_profile}>
                    ...
                    <form className="form" onSubmit={submitHandler}>
                        ...
                        <div className={clsx.form_group}>
                            ...
                            >
                                ...
                                <option value="PATH_FINDERS">
                                    Pathfinder Courses
                                </option>
                                <option value="HEAD_START">
                                    HeadStart Courses
                                </option>
                                <option value="UPSKILL_COURSES">
                                    Upskill Courses
                                </option>
                                <option value="IN_DEMAND">
                                    In Demand Career Courses
                                </option>
                                <option value="EXECUTIVE_COURSES">
                                    Executive Courses
                                </option>
                                <option value="SHORT_COURSES">
                                    Short Courses
                                </option>
                            ...
                            <div className={clsx.form_group}>
                                ...
                                {formstate.packages?.length > 0 ? (
                                    formstate.packages?.map((item, index) => (
                                        <div
                                            className={clsx.syllabus_container}
                                        >
                                            <h5>
                                                {changeConstants(item.title)}
                                            </h5>
                                            {<p>{item.price}</p>}
              ...
              <ReactQuill theme="snow" value={formstate?.description} onChange={setBio} />
                        ...
                        <div className={clsx.form_group}>
                            <label className="form-label generic_label">
                                Syllabus
                            </label>
                            {formstate.syllabus?.length !== 0 ? (
                                formstate.syllabus?.map(
                                    ({ title, description }, i) => (
                                        <div
                                            className={clsx.syllabus_container}
                                        >
