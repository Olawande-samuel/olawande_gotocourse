...
import CheckHero from "../../images/MITIFIX.png"
            ...
            <div className={style.checklist}>
                ...
                <div className={style.checklist_hero}>
                    <div className="container">
                        <div className={style.checklist__item}>
                            <div className={style.checklist__heroleft}>
                                <h4>
                                    Partner <span>with us.</span>
                                </h4>
                                <p>Gotocourse is everything <br />
                                    you need to teach what you love!
                                </p>
                                <span>
                                    Before you begin your journey, check if you are <br />
                                    eligible to teach on Gotocourse by answering  some questions
                                </span>

                            </div>
                            <div className={style.checklist__right}>
