...
const cards = [
    ...
    },
    {
        ...
        description: "Earn income for each new customer you refer and register on Go2course"        
    },
    {
        bgColor: "#DEECFF",
            ...
            <div className={clsx.affiliate}>
                ...
                <div className={clsx.get_started}>
                    ...
                    <div className={clsx.get_started_right}>
                        <h3>Get access to your customized dashboard, track your best works and earnings</h3>
                ...
                <div className={clsx.start_now}>
                    <div className={clsx.start_now__left}>
                        ...
                        <p>Earn up to 5% on qualifying registration to our program, our competitive conversion rate helps maximize earnings.</p>
