...
const cards = [
    ...
    },
    {
        ...
        description: "Earn income for each new customer you refer"        
    },
    {
        bgColor: "#DEECFF",
        ...
        description: "Get paid each month for every new customer you refer"        
    },
]
            ...
            <div className={clsx.affiliate}>
                <div className={clsx.affiliate_top}>
                    <div className={clsx.affiliate_top__absolute}>
                        <h2>Become a Go2course affiliate</h2>
                        <p>Earn commission from the sales made using <br /> your own link to learn</p>
                ...
                <div className={clsx.start_now}>
                    <div className={clsx.start_now__left}>
                        <h2>Make use of this oppurtunity to make money in this house</h2>
                        <p>Each course is designed to provide and gotten deeper into something</p>
