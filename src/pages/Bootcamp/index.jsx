        ...
        <Layout>
            <div className={clsx.bootcampTraining}>
                ...
                <section className={clsx.to_learn}>
                    ...
                    <ul>
                        <li>Design a high converting landing page from scratch without a single line of code.</li>     
                        <li>The right formula to get conversions from your landing page.</li>
                        <li>How to connect your landing page to a WordPress website to drive more traffic to your site..</li>
                        <li>How to create an ui ddesign to use that users love and interact with.</li>
                        <li>How to write an email to send people once they optin into your landing page.</li>
                        <li>What are some of best traffic sources to use to get clicks on your landing page.</li>
                        <li>How to create a WordPress website in 30 minutes.</li>
                        <li>Create a professional logo for your website.</li>
                        <li>Personal development training to get the right mindset to succeed at almost anything.</li>
                    </ul>
                    </div>
                </section>
                ...
                <section className={clsx.requirement}>
                    <div className="container">
                        ...
                        <p> This course is for beginners. You don't have to have any technical skills to get started other than knowing how to use a computer. The software is easy-use drag and drop technology. </p>
                        <ul>
                            <li>You don't need to know web coding.</li>
                            <li>A desire to learn new concepts that will help your online business succeed!</li>
                ...
                <section className={clsx.description}>
                    <div className="container">
                        <h3>Description</h3>
                        <p>This is not a web development course. This course will not teach you CSS, HTML, or JavaScript. This course will teach you how to create a simple yet effective landing page, known as an optin page. I will teach you that by designing this kind of landing page, you can get 30-60% higher conversions than your current website gets.</p>
                        <p>A good landing page isn't just there to make your website look more likable – it's absolutely essential to the success of your online business. Whether you're an English teacher, into eCommerce, or consulting. The effective and clear landing page design can make the difference between a positive and negative ROI.</p>
                        <p>There is no point in driving more traffic to your website if the conversion rate is 1-2%. Instead, you need to focus more on creating a higher converting landing page.</p>
                    </div>
                </section>
                ...
                <section className={clsx.teacher}>
                    <div className="container">
                        ...
                        <div className="d-flex flex-wrap align-items-center my-3">
                            <img src={Teacher}alt="tutor" className="img-fluid" width="300"  height="400" />
                            <div className="pt-3 pt-lg-0 ps-lg-4">
                                <h4>Mrs Cathline Brown</h4>
                                <p className="mb-0">Certified UI/Ux Designer</p>
                            </div>
                        </div>
                        <p>That working smart and hard are very important. For me starting an online business is a smart move because once you learn how to do it, you only have to work a few hours a week.</p>
...
function Card({title, image}){
    return (
        <div className="card" style={{width:"min(100%, 290px)"}}>
            ...
            <div className="card-body d-flex flex-column justify-content-between" style={{lineHeight:"30px"}}>
