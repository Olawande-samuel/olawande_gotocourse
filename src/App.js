            ...
            <Routes>
              <Route path="/" element={<Out />}>
                ...
                <Route
                  ...
                  element={<EndUserPolicy />}
                />
                <Route
                  path="teaching-policy"
                  element={<TeachingPolicy />}
                />
                ...
                <Route
                  ...
                  element={<HIWAffiliate />}
                />
                <Route
                  path="teachers-how-it-works"
                  element={<HIWTeacher />}
                />
                <Route
                ...
                <Route path="mentors" element={<Out />}>
                  <Route
                    index
                    element={<All type="mentors" />}
                  />
                  <Route path=":id" element={<Out />}>
                    <Route
                      index
                      element={
                        <TeacherProfile type="mentors" />
                      }
                    />
                  </Route>
                </Route>
                ...
                <Route path="mentor" element={<Out />}>
                  ...
                  <Route
                    path="profile/edit"
                    element={<EditMentorsProfile />}
                  />
                  <Route
                    path="notifications"
                    element={<MentorsNotification />}
                  />
                  <Route
                    path="earnings"
                    element={<MentorsEarnings />}
                  />
                  <Route
                    path="scheduler"
                    element={<MentorsScheduler />}
                  />
                  <Route
                    path="chat"
                    element={<MentorsChat />}
